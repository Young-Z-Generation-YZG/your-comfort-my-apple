...
const Footer = () => {
   ...
   return (
      <footer className='w-full h-full'>
         <div className='max-w-[1680px] w-[87.5vw] mx-auto font-SFProText mb-5'>
            <h2 className='mb-[53px] text-[56px] font-[600] leading-[60px]'>iPhone</h2>
            <div className='flex flex-wrap lg:flex-row '>
               <div className='w-full mb-14 lg:w-auto lg:mb-0 pr-[88px]'>
                  <h3 className='mb-[14px] text-[#6E6E73] text-[17px] font-normal leading-[21px]'>Khám Phá iPhone</h3>
                  <ul className='text-[28px] font-semibold leading-[32px]'>
                     <li className='mb-[11px]'>Khám Phá Tất Cả iPhone</li> 
                     <li className='mb-[11px]'>iPhone 16 Pro</li>
                     <li className='mb-[11px]'>iPhone 16</li>
                     <li className='mb-[11px]'>iPhone 16e</li>
                     <li className='mb-[11px]'>iPhone 15</li>
                     <li className='mb-[14px] mt-[30px] text-[17px] leading-[21px]'>So Sánh iPhone</li>
                     <li className='text-[17px] leading-[21px]'>Chuyển Từ Android</li>
                  </ul>
               </div>
               <div className='w-full mb-14 md:w-auto md:mb-0 pr-[44px]'>
                  <h3 className='mb-[14px] text-[#6E6E73] text-[17px] font-normal leading-[21px]'>Mua iPhone</h3>
                  <ul className='text-[17px] font-semibold leading-[21px]'>
                     <li className='mb-[14px]'>Mua iPhone</li>
                     <li className='mb-[14px]'>Phụ Kiện iPhone</li>
                     <li className='mb-[14px]'>Apple Trade In</li>
                     <li className=''>Tài Chính</li>
                  </ul>
               </div>
               <div className='w-full mb-14 md:w-auto md:mb-0 pr-[44px]'>
                  <h3 className='mb-[14px] text-[#6E6E73] text-[17px] font-normal leading-[21px]'>Tìm Hiểu Thêm Về iPhone</h3>
                  <ul className='text-[17px] font-semibold leading-[21px]'>
                     <li className='mb-[14px]'>Hỗ Trợ iPhone</li>
                     <li className='mb-[14px]'>AppleCare+ cho iPhone</li>
                     <li className='mb-[14px]'>iOS 18</li>
                     <li className='mb-[14px]'>Apple Intelligence</li>
                     <li className='mb-[14px]'>Các Ứng Dụng Của Apple</li>
                     <li className='mb-[14px]'>Quyền Riêng Tư Trên iPhone</li>
                     <li className='mb-[14px]'>iCloud+</li>
                     <li className='mb-[14px]'>Ví, Pay</li>
                  </ul>
               </div>
