...
const DetailProductPage = () => {
   ...
   const compare01 = listProduct.find(
      (product: CompareItemType) => product.id === selectedOption1,
   );
   const compare02 = listProduct.find(
      (product: CompareItemType) => product.id === selectedOption2,
   );
   const compare03 = listProduct.find(
      (product: CompareItemType) => product.id === selectedOption3,
   );
   ...
   return (
      <div
         className={cn(
            ...
            'font-SFProDisplay w-full flex flex-col items-start justify-center bg-[#fff]',
         )}
      >
         {/* CARRIER */}
            ...
            <div className="w-full bg-transparent flex flex-row relative pb-[30px]">
               ...
               <div className="basis-1/4 h-fit min-w-[328px]">
                  ...
                  <div className="type-color w-full mt-[100px]">
                     ...
                     <div
                        className="flex flex-row gap-3 pt-[17px] pb-[13px]"
                        style={{ opacity: visibleColor.visible ? 1 : 0.5 }}
                     >
                        {Array.from({ length: 5 }).map((_, index) => (
                           <ColorItem
                              key={index}
                  ...
                  <div className="type-storage w-full mt-[200px]">
                     ...
                     <div
                        ...
                        style={{ opacity: visibleStorage.visible ? 1 : 0.5 }}
                     >
         ...
         {/* INFO PRODUCT */}
         <div
            className="w-full mt-[73px] bg-[#f5f5f7] flex flex-col items-center overflow-hidden relative"
         ...
         >
            ...
            <div
               className="button-more w-10 h-10 absolute bottom-4 left-4 p-4 bg-black rounded-full flex justify-center items-center text-[25px] text-white hover:bg-[#ccc] hover:text-black cursor-pointer"
               ...
               <div className="w-full border-b border-black">
                  ...
                  <div className="w-full grid grid-cols-3">
                     ...
                     <div className="flex flex-col text-[13px] text-[#363636] font-light tracking-[0.5px]">
                        <div className="p-2">Rating Snapshot</div>
                     ...
                     <div className="flex flex-col text-[13px] text-[#363636] font-light tracking-[0.5px]">
                        ...
                        <div className="p-2 pt-0 flex flex-row justify-center">
                           <div className="w-[70px] text-[40px]">4.7</div>
                           <div className="flex flex-col justify-center">
                              <div className="flex flex-row gap-[2px] items-center">
                                 {starsRating(3.2)}
                              </div>
                              <div className="text-[#0077C8]">3759 Reviews</div>
                           </div>
                        </div>
                     </div>
                     ...
                     {/* Review this Product */}
                     <div className="flex flex-col text-[13px] text-[#363636] font-light tracking-[0.5px]">
                        <div className="p-2">Review this Product</div>
            ...
            <div className="compare-content bg-transparent w-[996px] mx-auto flex flex-col">
                  ...
                  <div className="basis-1/3  bg-gray-300 flex flex-col items-center rounded-[10px]">
                     ...
                     >
                        ...
                        <SelectContent className="bg-white">
                           {listProduct.map(
                              (product: productTypeTemp, index: number) => (
               ...
               <div
                  className={cn(
                     ...
                     showDetailCompare ? 'h-fit' : 'h-[1360px] overflow-hidden',
                  )}
               >
                  {compare01 && (
                     <CompareItem
               ...
               >
                  <Button
                     ...
                     className={cn(
                        'w-[140px] bg-black text-white uppercase px-10 text-xl hover:bg-[#333]',
                     )}
                     variant={'default'}
                  >
