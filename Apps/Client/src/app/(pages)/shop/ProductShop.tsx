                                   ...
                                   <div className='flex flex-row gap-2'>
                                        {storages.map((storage,index) => {
                                             return (
                                                  ...
                                                  className='w-14 h-fit px-2 py-0 border border-[#000] rounded-full text-[13px] font-light bg-[#000] text-white'>
                                                       {storage}
                                                  </Button>
                                                  :
                                                  <Button 
                                                  key={index}
                                                  onClick={()=>handleStorage(index)}
                                                  className='w-14 h-fit px-2 py-0 border border-[#000] rounded-full text-[13px] font-light hover:bg-[#000] hover:text-white'>
                                                       {storage}
                                                  </Button>
                                             )
                                        })}
