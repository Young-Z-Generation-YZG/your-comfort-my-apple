...
import CartWrapper from './CardWrapper';
      ...
      <div className="col-span-1" key={index + 1}>
         ...
         <CartWrapper>
            <div className="relative cursor-pointer">
               ...
               <div className="flex items-center justify-center overflow-hidden bg-[#f5f5f7] transition-all hover:shadow-md">
                  <Link href="#">
                     <Image
                        src={`${item.product_variants.find((v) => v.color_name === selectedVariant)?.product_color_image ?? item.product_variants[0].product_color_image}?wid=800&hei=800`}
                        alt={item.promotion_product_name}
                        width={1000}
                        height={1000}
