...
import LastestItem from '~/app/(pages)/home/LastestItem';
import ExperienceItem from '~/app/(pages)/home/ExperienceItem';
import CompareItem from '~/app/(pages)/home/CompareItem';
...
const HomePage = () => {
   ...
   const [selectedOption5, setSelectedOption5] = useState('ip12mini');
               ...
               <Carousel className="w-full max-w-screen relative flex justify-center items-center">
                  <CarouselContent className="w-screen pl-[140px] mb-5">
                     {listLatestItem.map((product, index) => {
                        return (
                           <CarouselItem key={index} className="md:basis-[30%] mr-[3px]">
               ...
               <Carousel className="w-full max-w-screen relative flex justify-center items-center">
                  <CarouselContent className="w-screen pl-[140px] mb-5">
                     {listExperienceItem.map((item, index) => {
                        return (
                           <CarouselItem key={index} className="md:basis-1/3 mr-[38px]">
         ...
         <div className='compare-container w-full mb-[100px] flex flex-col justify-center items-center'>
            ...
            <div className='compare-content bg-transparent w-[996px] mx-auto flex flex-col'> 
               <div className='w-full flex flex-row gap-3 mb-10'>
                  <div className='basis-1/5  bg-gray-300 flex flex-col items-center rounded-[10px]'>
                     <Select 
                  ...
                  <div className='basis-1/5  bg-gray-300 flex flex-col items-center rounded-[10px]'>
                     <Select 
                        ...
                        onValueChange={(value) => setSelectedOption5(value)}
                     >
                        <SelectTrigger className="w-full text-base font-medium bg-white">
                           <SelectValue />
                        </SelectTrigger>
               ...
               <div className='w-full flex flex-row gap-3'>
                  ...
                  <CompareItem compare={listProduct.find((product:any) => product.id === selectedOption5)} />
               </div>
               {/* <div className='basis-1/5  bg-gray-400 flex flex-col items-center'>
                  <div className='w-full h-[280px] bg-gray-300 flex justify-center items-end'>
                     <Image  
                        className='h-fit w-full px-2' src='/images/test-compare-imgs/iphone_14_pro_max.png' 
                        alt="Picture of the author" 
                        width={1000} 
                        height={1000} 
                        quality={100}/>
                  </div>   
                  <div className='w-full h-[92px] bg-red-300 flex justify-center items-center'>
                     <Image  
                        className='h-fit w-full px-2' src='/images/test-compare-imgs/iphone_14_pro_max.png' 
                        alt="Picture of the author" 
                        width={1000} 
               ...
               {/* <div className='grid grid-cols-[repeat(5,minmax(170px,1fr))] grid-rows-[masonry] grid-flow-dense gap-[30px]'>
                  <div className="bg-black row-end-[span_2] rounded-[20px] h-[356px]"></div>
                  <div className="bg-black row-end-[span_2] rounded-[20px] h-[356px]"></div>
                  <div className="bg-black row-end-[span_2] rounded-[20px] h-[356px]"></div>
                  <div className="bg-black row-end-[span_2] rounded-[20px] h-[356px]"></div>
                  <div className="bg-black row-end-[span_2] rounded-[20px] h-[356px]"></div>
