...
const Test = () => {
   ...
   return (
      <div className='w-full flex flex-col items-center justify-center'>
         <div className='hero-container max-w-[1264px] bg-cyan-200 mb-[32px] flex flex-row mx-auto'>
            <div className='hero-content basis-[55%] bg-gray-500'>
               <div className='content-header'>Financial infrastructure to grow your revenue</div>
            ...
            <div className='hero-masonry basis-[45%] bg-green-500'> 
               <div className=' grid grid-cols-[repeat(2,minmax(200px,1fr))] grid-rows-[masonry] grid-flow-dense gap-[10px]'>
                  {/* <div className='bg-red-400 h-fit  row-end-[span_2]'>
                     <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, excepturi dolorem! A, recusandae error. Mollitia incidunt culpa inventore quae quis eveniet, similique ipsa, nisi, cum dolorum voluptas a sed.</p>
                  </div>
         ...
         <div className='preview-container w-full bg-[#161616] mb-[32px] '>
            <div className='preview-masonry bg-transparent py-[100px] max-w-[996px] mx-auto'> 
               <div className=' grid grid-cols-[repeat(6,minmax(150px,1fr))] grid-rows-[masonry] grid-flow-dense gap-[19px]'>
                  ...
                  {/* <div className='bg-black col-end-[span_4] flex flex-row rounded-[20px]' style={{blockSize:"400px"}}>
                     <div className='track-img w-full flex justify-center items-center '>
                        <Image 
                           className='h-full w-full rounded-[20px]' src='/images/preview-imgs/picture09.png' 
                           alt="Picture of the author" 
                           width={1000}   
                           height={1000} 
                           quality={100}/>
         ...
         <div className='hero-container w-full h-[500px] bg-cyan-200 mb-[32px]'>
