...
const IphoneModel = ({
   ...
   // Model names display
   const modelNames = productModel.model_items.map((item) => item.name);
   const displayName =
      modelNames.length > 1
   ...
   return (
      <Fragment>
         <div
            className={cn(
               'flex flex-row bg-white px-5 py-5 rounded-md',
               className,
            )}
         >
            {/* image */}
            {showcaseImage && (
               <div className="basis-[20%] overflow-hidden relative h-[300px] rounded-lg">
                  <Image
                     src={showcaseImage.image_url}
                     alt={showcaseImage.image_name || productModel.name}
            ...
            <div className="flex flex-col relative basis-[45%] px-7">
               <div className="content flex flex-col gap-2">
                  ...
                  <div className="flex flex-row gap-2">
                     {productModel.color_items.map((color, index) => (
                        <div
                           key={index}
                           className={cn(
                  ...
                  {/* start storage */}
                  <div className="flex flex-row gap-2">
                     {productModel.storage_items.map((storage, index) => (
                        <span
                           key={index}
                           className={cn(
                  ...
                  {productModel.rating_stars &&
                     productModel.rating_stars.length > 0 && (
                  ...
                  <div className="flex flex-row gap-2 mt-2 items-center">
                     ...
                     <span className="text-sm font-semibold">
                        {productModel.overall_sold.toLocaleString()} units
                     </span>
                  </div>
