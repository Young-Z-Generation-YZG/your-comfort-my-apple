         ...
         <div className="product-item w-full flex flex-row justify-start">
            ...
            <div className="flex-1 flex flex-col justify-start items-start pl-[16px]">
               ...
               <div className="w-full flex flex-row justify-end">
                  <Button className="relative w-8 h-6 border border-[#ebebeb] bg-sky-400 hover:bg-sky-500 rounded-l-full flex p-0 z-0">
                  ...
                  <Input
                     ...
                     onChange={() => {}}
                  />
                  <Button className="relative w-8 h-6 border border-[#ebebeb] bg-sky-400 hover:bg-sky-500 rounded-r-full flex p-0">
                     <p className="absolute h-1 top-0 bottom-0 right-3">+</p>
                  </Button>
               </div>
            </div>
