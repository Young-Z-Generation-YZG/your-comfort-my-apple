...
public class VnpayIpnCheckCommandHandler : ICommandHandler<VnpayIpnCheckCommand, OrderDetailsResponse>
{
    private readonly IVnpayProvider _vnpayProvider;
    private readonly IOrderRepository _orderRepository;
    private readonly ILogger<VnpayIpnCheckCommandHandler> _logger;

    public VnpayIpnCheckCommandHandler(IVnpayProvider vnpayProvider, IOrderRepository orderRepository, ILogger<VnpayIpnCheckCommandHandler> logger)
    {
