...
public class GetOnlineOrdersQueryHandler : IQueryHandler<GetOnlineOrdersQuery, PaginationResponse<OrderDetailsResponse>>
{
    ...
    public async Task<Result<PaginationResponse<OrderDetailsResponse>>> Handle(GetOnlineOrdersQuery request, CancellationToken cancellationToken)
    {
    ...
    private static PaginationResponse<OrderDetailsResponse> MapToResponse(List<Order> orders, int totalRecords, int totalPages, GetOnlineOrdersQuery request)
    {
