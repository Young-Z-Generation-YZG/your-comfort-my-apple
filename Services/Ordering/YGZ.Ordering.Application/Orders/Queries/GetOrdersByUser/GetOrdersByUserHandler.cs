...
public class GetOrdersByUserHandler : IQueryHandler<GetOrdersByUserQuery, PaginationResponse<OrderResponse>>
{
    private readonly IOrderRepository _orderRepository;
    private readonly IUserRequestContext _userContext;

    public GetOrdersByUserHandler(IOrderRepository orderRepository, IUserRequestContext userContext)
    {
