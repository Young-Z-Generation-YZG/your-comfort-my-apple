...
- **standard OIDC Discovery endpoint**: `/.well-known/openid-configuration`
  ...
  - It provides a JSON document (the "OpenID Provider Metadata") containing configuration details about the OIDC provider, such as supported endpoints, authentication methods, and token formats.
