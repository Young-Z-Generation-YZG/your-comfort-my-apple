...
public static class SeedTenantData
{
    public static IEnumerable<Tenant> Tenants
    {
        get
        {
            ...
            {
                Tenant.Create(TenantId.Of("664355f845e56534956be32b"), "YBZone", "admin", ETenantType.WAREHOUSE, Branch.Create(BranchId.Of("664357a235e84033bbd0e6b6"), TenantId.Of("664355f845e56534956be32b"), "YBZone", "Online shop", null)),
                ...
                Tenant.Create(TenantId.Of("690e034dff79797b05b3bc91"), "HCM Q9 LVV 123", "hcm-q9-lvv-123", ETenantType.BRANCH, Branch.Create(BranchId.Of("690e034dff79797b05b3bc13"), TenantId.Of("690e034dff79797b05b3bc91"), "HCM_Q9_LVV_123", "số 123, Lê Văn Việt, phường Tăng Nhơn Phú A, Quận 9", null))
            };
        }
    }
}
