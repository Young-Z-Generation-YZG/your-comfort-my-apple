    ...
    public static IEnumerable<Tenant> Tenants
    {
        get
        {
            return new List<Tenant>
            {
                ...
                Tenant.Create(TenantId.Of("690e034dff79797b05b3bc89"), "", "hcm-td-kvc-1060", ETenantType.BRANCH, Branch.Create(BranchId.Of("690e034dff79797b05b3bc88"), TenantId.Of("690e034dff79797b05b3bc89"), "HCM_TD_KVC_1060", "Số 1060, Kha Vạn Cân, Linh Chiểu, TD", null))
            };
        }
    }
