    ...
    public static IEnumerable<Tenant> Tenants
    {
        get
        {
            return new List<Tenant>
            {
                ...
                Tenant.Create(TenantId.Of("690e034dff79797b05b3bc90"), "HCM Q1 CMT8 92", "hcm-td-kvc-1060", ETenantType.BRANCH, Branch.Create(BranchId.Of("690e034dff79797b05b3bc12"), TenantId.Of("690e034dff79797b05b3bc90"), "HCM_Q1_CMT8_92", "số 92, Cách Mạng Tháng 8, Quận 1, Quận 1", null)),
                Tenant.Create(TenantId.Of("690e034dff79797b05b3bc91"), "HCM Q9 LVV 123", "hcm-td-kvc-1060", ETenantType.BRANCH, Branch.Create(BranchId.Of("690e034dff79797b05b3bc13"), TenantId.Of("690e034dff79797b05b3bc91"), "HCM_Q9_LVV_123", "số 123, Lê Văn Việt, phường Tăng Nhơn Phú A, Quận 9", null))
            };
        }
    }
